...
class RentRoomAdapter : RecyclerView.Adapter<RentRoomViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RentRoomViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.rv1_item_list, parent, false)
        return RentRoomViewHolder(view)
    }

    override fun onBindViewHolder(holder: RentRoomViewHolder, position: Int) {
        val imageView:ImageView = holder.itemView.findViewById(R.id.unsplash_1)
        val textView1: TextView = holder.itemView.findViewById(R.id.txt_1)
        val textView2: TextView = holder.itemView.findViewById(R.id.txt_2)
        val textView3: TextView = holder.itemView.findViewById(R.id.txt_3)
